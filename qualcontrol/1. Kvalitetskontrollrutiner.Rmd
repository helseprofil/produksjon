...
```{r}
readfiles(cube.new = "TRANGBODDHET_2023-11-20-11-05", # KUBENAVN_DATOTAG. Funksjonen leser fra QC-mappen om filen finnes der, ellers DATERT. 
          modus.new = "KH", # KH eller NH
          recode.new = FALSE, # Rekode til gjeldende GEO?
          cube.old = "TRANGBODDHET_2023-01-03-14-38", # Kan også være NULL
...
```{r}
compare_censoring(cube.old = NULL,
                  by = "AAR", 
                  filter.cubes = FALSE)
```
