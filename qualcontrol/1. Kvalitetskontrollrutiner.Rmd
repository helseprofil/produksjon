...
```{r}
readfiles(cube.new = "GJELD_2026-05-29-10-54", # KUBENAVN_DATOTAG. Funksjonen leser fra QC-mappen om filen finnes der, ellers DATERT. 
          recode.new = FALSE, # Rekode til gjeldende GEO?
          cube.old = "GJELD_2025-02-24-14-59", # Kan også være NULL
